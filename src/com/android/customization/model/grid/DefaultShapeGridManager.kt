...
constructor(
    ...
    override fun getGridOptionDrawable(iconId: Int): Drawable? {
        val pkgName = context.getString(com.android.themepicker.R.string.launcher_overlayable_package)
        try {
            val drawable =
            ...
            Log.w(
                TAG,
                "Unable to find drawable resource from $pkgName with resource ID $iconId",
            )
            return null
        }
    }
